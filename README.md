...
**Планы запросов будут выведены вместе с самими запросами при запуске скрипта. Но также их можно увидеть в файле [`QUERY_PLANS.pdf`](QUERY_PLANS.pdf) (препросмотр недоступен)**
