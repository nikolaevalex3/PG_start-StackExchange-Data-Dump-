...
## Визуализация
Я использовал Metabase. Запрос прищлось немного изменить, чтобы показать вызуализацию соответсвующкю задаче. Визуализация ограничена пятнадцатью самыми популярными парами.
